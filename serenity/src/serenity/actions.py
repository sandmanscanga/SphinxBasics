...
def change_pilot(firefly: Firefly, pilot: str) -> None:
    ...
    Summary:
        ...
        given value. The function takes a Firefly instance and a
        string with the new pilot's name as arguments. The function
        then sets the pilot attribute of the Firefly instance to the
        given value.
