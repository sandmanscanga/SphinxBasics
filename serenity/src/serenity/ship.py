...
class Firefly:
    ...
    character. The ship has a number of passengers and a direction.
    The ship also has a pilot who can change the direction of the
    ship. The ship can also perform a "crazy Ivan" maneuver to
    ...
    def __init__(self, passengers: int = 3) -> None:
        ...
        passengers. The default number of passengers is 3. The ship
        is facing in the 0 degree direction by default and the pilot
        is Wash. The ship is ready to fly.
    ...
    def crazy_ivan(self) -> int:
        ...
        degrees. This is a maneuver that is known as a "crazy Ivan"
        and is used to quickly change direction.
